...
/* ── Platform icons for print (inline SVGs so they render without external files) ── */
function PrintPlatformIcon({ name, size = 14 }: { name?: string | null; size?: number }) {
  ...
  switch (name) {
    case 'WordPress': return <svg {...svgProps}><path d="M12 2C6.486 2 2 6.486 2 12s4.486 10 10 10 10-4.486 10-10S17.514 2 12 2ZM3.5 12c0-1.72.52-3.32 1.41-4.65l3.89 10.66A8.503 8.503 0 0 1 3.5 12Zm8.5 8.5c-.83 0-1.63-.12-2.39-.34l2.54-7.37 2.6 7.12c.02.04.04.08.06.11A8.47 8.47 0 0 1 12 20.5Zm1.1-12.47c.51-.03.97-.08.97-.08.46-.05.4-.72-.05-.7 0 0-1.37.11-2.26.11-.83 0-2.23-.11-2.23-.11-.46-.03-.51.68-.05.7 0 0 .43.06.88.08l1.31 3.59-1.84 5.52-3.06-9.11c.51-.03.97-.08.97-.08.46-.05.4-.72-.05-.7 0 0-1.37.11-2.26.11-.16 0-.35 0-.55-.01A8.49 8.49 0 0 1 12 3.5c2.13 0 4.07.78 5.56 2.07-.04 0-.07-.01-.11-.01-.83 0-1.42.72-1.42 1.5 0 .7.4 1.29.83 1.99.32.56.7 1.28.7 2.32 0 .72-.28 1.55-.64 2.71l-.84 2.81-3.06-9.1Zm3.48 10.82 2.54-7.34c.47-1.19.63-2.14.63-2.99 0-.31-.02-.59-.06-.86A8.48 8.48 0 0 1 20.5 12a8.5 8.5 0 0 1-3.42 6.85Z" /></svg>
    case 'Shopify': return <svg {...svgProps}><path d="M15.34 4.95s-.2.05-.54.15c-.07-.23-.17-.49-.31-.76-.46-.88-1.13-1.35-1.94-1.35l-.17.01c-.03-.03-.05-.06-.08-.09C11.88 2.45 11.36 2.26 10.73 2.28c-1.22.03-2.43.91-3.41 2.48-.69 1.1-1.21 2.49-1.36 3.56l-2.37.73c-.7.22-.72.24-.81.9-.07.49-1.89 14.55-1.89 14.55L14.82 27l7.29-1.82S15.38 5 15.34 4.95Zm-2.22.67c-.54.17-1.13.35-1.74.54.33-1.28.97-1.92 1.8-2.15.22.41.34.97.34 1.61h-.4Zm-1.26-2.09c.12 0 .22.01.32.04-.85.4-1.75 1.41-2.14 3.43-.49.15-.96.3-1.41.44.39-1.81 1.55-3.86 3.23-3.91Zm.42 8.47s-.59-.31-1.32-.31c-1.07 0-1.12.67-1.12.84 0 .92 2.4 1.27 2.4 3.43 0 1.7-1.08 2.79-2.53 2.79-1.74 0-2.63-1.08-2.63-1.08l.47-1.55s.92.79 1.69.79c.5 0 .71-.4.71-.69 0-1.2-1.97-1.25-1.97-3.23 0-1.66 1.19-3.26 3.6-3.26.93 0 1.39.27 1.39.27l-.69 1.5Z" /></svg>
    case 'Webflow': return <svg {...svgProps}><path d="M17.55 8.2s-2.36 7.24-2.5 7.67c-.06-.46-1.27-7.67-1.27-7.67a3.22 3.22 0 0 0-3.12-2.22c0 0 1.75 5.38 2.02 6.23-.52.81-2.74 4.22-2.74 4.22a3.15 3.15 0 0 0-2.96-2.06c0 0-1.7 5.94-1.78 6.22A3.17 3.17 0 0 0 2 17.58h2.06l1.15-4.07a3.22 3.22 0 0 0 3.1 2.39s1.83-2.86 2.17-3.41c.33 1.06 1.17 3.41 1.17 3.41a3.23 3.23 0 0 0 3.12 2.09l3.09-9.75A3.22 3.22 0 0 0 22 5.98h-2.1l-2.35 8.22Z" /></svg>
    case 'Wix': return <svg {...svgProps}><path d="M4.8 7.24c-.38.23-.69.72-.87 1.05-.3.58-.42 1.23-.42 1.89v5.58l-1.2-3.31c-.18-.49-.42-.95-.76-1.35-.2-.24-.64-.64-1-.64v5.22c0 .52.06 1.04.29 1.51.2.4.55.73.96.91V7.24Zm4.88-.24c-.47 0-.87.19-1.18.54-.27.31-.38.68-.49 1.07l-1.6 5.77V7c-.42.2-.77.54-.97.97-.22.47-.28.98-.28 1.49v6.76L7.08 10c.23-.84.39-1.55 1.01-2.18.38-.39.88-.67 1.42-.77l-1.83 6.71 1.97-6.6c.24-.8.41-1.38 1.03-1.94v-.01ZM12 7l-1.91 6.83L12 7.45l1.91 6.38L12 7Zm4.32.24v5.87l-1.6-5.77c-.11-.39-.22-.76-.49-1.07-.31-.35-.71-.54-1.18-.54.54.1 1.04.38 1.42.77.62.63.78 1.34 1.01 2.18l1.92 6.54V9.46c0-.51-.06-1.02-.28-1.49-.2-.43-.55-.77-.97-.97v7.38l-1.6-5.77c-.18-.49-.42-.95-.76-1.35-.2-.24-.64-.64-1-.64v5.22c0 .52.06 1.04.29 1.51.2.4.55.73.96.91V7.24Z" /></svg>
    case 'Squarespace': return <svg {...svgProps}><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2Zm4.95 11.54-3.41 3.41a2.18 2.18 0 0 1-3.08 0L7.05 13.54a.5.5 0 0 1 0-.71l.35-.35a.5.5 0 0 1 .71 0l3.41 3.41c.39.39 1.03.39 1.42 0l3.41-3.41a.5.5 0 0 1 .71 0l.35.35c.2.2.2.51-.01.71Zm-1.42-1.42-3.41 3.41c-.39.39-1.02.39-1.41 0L7.3 12.12a.5.5 0 0 1 0-.71l.35-.35a.5.5 0 0 1 .71 0l3.41 3.41a.5.5 0 0 0 .71 0l3.41-3.41a.5.5 0 0 1 .71 0l.35.35c.2.2.2.52 0 .71Zm0-2.83-3.41 3.41a.5.5 0 0 1-.71 0L8.02 9.29a1 1 0 0 1 0-1.41l.35-.36a1 1 0 0 1 1.41 0l2.35 2.35a.5.5 0 0 0 .71 0l2.34-2.35a1 1 0 0 1 1.42 0l.35.36a1 1 0 0 1-.12 1.41Z" /></svg>
    ...
    default: return name ? <Globe style={s} /> : <HelpCircle style={s} />
  }
}
